...
const card = JSON.parse(readFileSync('/tmp/wepost-daily-2026-08-25.json', 'utf8'));
...
await el.screenshot({ path: '/Users/a1/Develop/wepost-cards/2026-08-25-ai-daily.png', type: 'png' });
await browser.close();
console.log('DONE');