      ...
      >
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 id="wechat-modal-title" className="text-sm font-bold flex items-center gap-2">
                <span>发布到微信公众号草稿箱</span>
          ...
          <div className="flex items-center gap-2">
            {/* 切换 Tab 按钮 */}
            <div
              className={`flex p-0.5 rounded-lg text-xs font-medium ${
                      ...
                      <div className="flex items-center gap-3 pt-1">
                        {publishResult.previewUrl && (
                          <a
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-semibold transition-all"
                          >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border font-semibold transition-all ${
                            dark
          ...
          <div className="flex items-center gap-2.5">
            ...
            {activeTab === 'publish' && (
              <button
                ...
                className="px-5 py-2 text-xs font-bold rounded-lg flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-neutral-950 shadow-lg shadow-emerald-500/20 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {publishStep !== 'idle' &&
                publishStep !== 'success' &&
                publishStep !== 'error' ? (
