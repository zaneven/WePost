    ...
    return (
      <header className="h-14 border-b border-neutral-200 bg-white/95 dark:border-neutral-800/90 dark:bg-neutral-950/95 backdrop-blur-xl w-full flex-shrink-0 z-50 px-3 sm:px-5 flex items-center justify-between text-neutral-900 dark:text-neutral-100 select-none overflow-hidden">
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
          ...
          {/* GitHub 仓库链接 */}
          <a
            href="https://github.com/zaneven/WePost"
            target="_blank"
            rel="noopener noreferrer"
            title="GitHub 源码仓库 (zaneven/WePost)"
            aria-label="GitHub 源码仓库"
            className="p-2 rounded-lg border border-neutral-200 bg-neutral-50 text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:text-white dark:hover:bg-neutral-800 transition-all inline-flex items-center justify-center cursor-pointer"
          >
